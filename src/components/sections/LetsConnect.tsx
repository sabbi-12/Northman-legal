  ...
  return (
    <section id="lets-connect" className="bg-cream py-24 dark:bg-navy-dark">
      <div className="container-institutional grid gap-14 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.3fr)]">
        <div>
          ...
          <ul className="mt-10 space-y-5 text-sm text-slate-mid dark:text-cream/70">
            ...
            <li className="flex items-center gap-3">
              <Phone size={18} strokeWidth={1.75} className="shrink-0 text-gold" aria-hidden="true" />
            ...
            <li className="flex items-center gap-3">
              <Mail size={18} strokeWidth={1.75} className="shrink-0 text-gold" aria-hidden="true" />
        ...
        <div className="rounded-institutional border border-navy/10 bg-white p-8 shadow-institutional dark:border-cream/10 dark:bg-navy/40 md:p-10">
